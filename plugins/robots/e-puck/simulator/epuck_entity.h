...
namespace argos {
   ...
   public:
      ...
      inline CHumanSensorEquippedEntity& GetHumanSensorEquippedEntity() {
         return *m_pcHumanSensorEquippedEntity;
      }
   ...
   private:
      ...
      CHumanSensorEquippedEntity*            m_pcHumanSensorEquippedEntity;
