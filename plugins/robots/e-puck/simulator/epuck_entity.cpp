...
namespace argos {
   ...
   CEPuckEntity::CEPuckEntity() :
      ...
      m_pcHumanSensorEquippedEntity(NULL) {
   }
   ...
   void CEPuckEntity::Init(TConfigurationNode& t_tree) {
      try {
         ...
         /* Human sensor equipped entity */
         m_pcHumanSensorEquippedEntity =
                 new CHumanSensorEquippedEntity(this,
                         "human_0");
         AddComponent(*m_pcHumanSensorEquippedEntity);
         m_pcHumanSensorEquippedEntity->AddSensorRing(
                 CVector3(0.0f, 0.0f, PROXIMITY_SENSOR_RING_ELEVATION),
                 PROXIMITY_SENSOR_RING_RADIUS,
                 PROXIMITY_SENSOR_RING_START_ANGLE,
                 PROXIMITY_SENSOR_RING_RANGE,
