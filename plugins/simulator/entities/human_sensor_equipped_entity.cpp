/*
 * human_sensor_equipped_entity.cpp
 *
...
namespace argos {
    ...
    CHumanSensorEquippedEntity::CHumanSensorEquippedEntity(CComposableEntity* pc_parent) :
        CEntity(pc_parent) {
    ...
    CHumanSensorEquippedEntity::~CHumanSensorEquippedEntity() {
    ...
    void CHumanSensorEquippedEntity::Init(TConfigurationNode& t_tree) {
        try {
            /*
            ...
            THROW_ARGOSEXCEPTION_NESTED("Initialization error in human sensor equipped entity", ex);
        }
    }
    ...
    void CHumanSensorEquippedEntity::AddSensor(const CVector3& c_position,
    ...
    void CHumanSensorEquippedEntity::AddSensorRing(const CVector3& c_center,
            Real f_radius,
    ...
    REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CHumanSensorEquippedEntity);
